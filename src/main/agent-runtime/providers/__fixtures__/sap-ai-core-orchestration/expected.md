# sap-ai-core-orchestration — expected stream shape
...
HTTP operation URL is `/inference/deployments/{deploymentId}/v2/completion`. Deployment id is a connection value, not a catalog secret.
