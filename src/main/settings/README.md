...
- `ModelProviderRegistry` 是 runtime capability matrix 入口；OpenAI/Claude SDK backend、OpenAI-compatible/local/environment provider 都必须通过该能力边界与 runtime policy 连接。
