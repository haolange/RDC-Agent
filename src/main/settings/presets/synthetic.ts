...
const preset: ProviderPreset = {
  ...
  discovery: { kind: 'json-catalog', path: '/models', collectionPath: '$', mapping: { id: 'id', label: 'name', contextWindow: 'context_length', modality: 'input_modalities' }, admission: { allowedModalities: ['text', 'image'] }, modelSet: 'authoritative' },
