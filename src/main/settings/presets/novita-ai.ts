...
const preset: ProviderPreset = {
  ...
  discovery: { kind: 'json-catalog', path: '/models', collectionPath: 'data', mapping: { id: 'id', label: 'title', contextWindow: 'context_size' }, admission: { denyPatterns: ['*embed*', '*bge*', '*rerank*'] }, modelSet: 'authoritative' },
