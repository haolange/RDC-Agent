...
`src/main/tools` owns the main-process boundary for invoking system-installed RDC-Tool CLI commands.
...
- No bundled RDC tool copy or repository resource fallback is allowed in this layer.
