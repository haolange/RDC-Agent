...
const entry = (
  ...
  contentUri: `rdc://investigation/records/${artifactId}.json`,
  manifestUri: `rdc://investigation/manifests/${artifactId}.json`,
...
const manifestOf = (
  ...
  contentRef: extras.contentRef ?? `rdc://investigation/records/${artifactId}.json`,
