  ...
  readonly api: ElectronAPI = {
    ...
    memory: {
      ...
      getRequestSnapshot: (sessionId, turnId, snapshotId) => this.invoke('rdx-runtime:getSnapshot', sessionId, turnId, snapshotId),
                ...
                generativeUi: {
                  run: (request) => this.invoke('generative-ui:run', request),
                  create: (projectId, sessionId, title, prompt) => this.invoke('generative-ui:create', projectId, sessionId, title, prompt),
                  list: (sessionId) => this.invoke('generative-ui:list', sessionId),
                  metrics: (sessionId) => this.invoke('generative-ui:metrics', sessionId),
                  evidenceList: (sessionId) => this.invoke('generative-ui:evidenceList', sessionId),
                  evidenceAdd: (sessionId, request) => this.invoke('generative-ui:evidenceAdd', sessionId, request),
                  outerReport: (sessionId) => this.invoke('generative-ui:outerReport', sessionId),
                  benchmarkList: () => this.invoke('generative-ui:benchmarkList'),
                  benchmarkRun: (projectId, sessionId, caseId) => this.invoke('generative-ui:benchmarkRun', projectId, sessionId, caseId),
                  get: (sessionId, canvasId) => this.invoke('generative-ui:get', sessionId, canvasId),
                  commit: (sessionId, request) => this.invoke('generative-ui:commit', sessionId, request),
                  createBranch: (sessionId, canvasId, name, fromVersionId) => this.invoke('generative-ui:createBranch', sessionId, canvasId, name, fromVersionId),
                  switchBranch: (sessionId, canvasId, branchId) => this.invoke('generative-ui:switchBranch', sessionId, canvasId, branchId),
                  stop: (sessionId, canvasId, reason) => this.invoke('generative-ui:stop', sessionId, canvasId, reason),
                  getPreview: (sessionId, canvasId, versionId) => this.invoke('generative-ui:getPreview', sessionId, canvasId, versionId),
                  observe: (sessionId, canvasId, versionId, eventType, details) => this.invoke('generative-ui:observe', sessionId, canvasId, versionId, eventType, details),
                  feedback: (sessionId, canvasId, versionId, value) => this.invoke('generative-ui:feedback', sessionId, canvasId, versionId, value),
                  export: (sessionId, canvasId, versionId) => this.invoke('generative-ui:export', sessionId, canvasId, versionId),
                },
    command: {
