...
const englishTranslations = {
  ...
  'mode.debuggerEmptyTitle': 'Start from the visible symptom and locate the GPU issue',
  'mode.debuggerEmptySubtitle': 'Use `.rdc` captures, screenshots, and clues to start narrowing it down quickly.',
  'mode.analyzerEmptyTitle': 'Break down clues and connect the evidence',
  'mode.analyzerEmptySubtitle': 'Best for comparing symptoms, organizing context, and narrowing the reasoning path.',
  'mode.optimizerEmptyTitle': 'Find the bottleneck first, then prioritize optimizations',
  'mode.optimizerEmptySubtitle': 'Best for evaluating performance gains, implementation cost, and validation order.',
  'chat.you': 'You',
  'chat.system': 'System',
...
const zhCnOverrides: Partial<Record<TranslationKey, string>> = {
  ...
  'mode.analyzer': 'Analyzer',
  'mode.optimizer': 'Optimizer',
  'mode.debuggerEmptyTitle': '从异常现象出发，定位 GPU 问题',
  'mode.debuggerEmptySubtitle': '围绕 `.rdc` Capture、截图与线索快速展开排查。',
  'mode.analyzerEmptyTitle': '拆开线索，串起证据',
  'mode.analyzerEmptySubtitle': '适合对比现象、梳理上下文与收敛判断方向。',
  'mode.optimizerEmptyTitle': '先找瓶颈，再排优化顺序',
  'mode.optimizerEmptySubtitle': '适合评估性能收益、成本与验证优先级。',
  'chat.you': '你',
  'chat.system': '系统',
  'chat.thinking': '正在思考',
