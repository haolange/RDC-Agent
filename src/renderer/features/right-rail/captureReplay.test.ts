...
const replay: CaptureReplayState = { ...scope, generation: 3, operationId: null, revision: 8, phase: 'ready', inputId: 'input', captureHash: 'hash', contextId: 'context', replayDeviceId: 'local', requestedEventId: 42, appliedEventId: 42, imageEventId: 21, events: [{ eventId: 21 }, { eventId: 42 }], targets: [], target: null, isFinalOutput: false, image: null, devicePresentation: { status: 'not_applicable', eventId: null, textureId: null, sequence: null, reason: null }, interactionLock: null, error: null, warning: null, observation: null, agentObservation: null };
