...
/**
 * Right rail empty-state illustrations: isometric frosted-glass scenes.
...
const softBlur = (id: string, deviation = 3.2) => (
...
const ProgressVisual: React.FC = () => {
  ...
  return (
    <svg className="right-rail-empty-visual progress-visual" viewBox="0 0 200 112" aria-hidden="true">
      ...
      <circle className="rr-eg-active-glow" cx={160} cy={34.76} r={7} filter={`url(#${glow})`} />
      <circle className="rr-eg-active-core" cx={160} cy={34.76} r={3.2} />
    </svg>
  );
};
