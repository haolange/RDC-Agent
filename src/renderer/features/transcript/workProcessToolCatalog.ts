...
export const WORK_PROCESS_TOOL_DISPLAY_CATALOG: Record<string, WorkProcessToolDisplay> = {
  ...
  turn_complete: { icon: 'turnComplete', groupKind: 'task', category: '任务完成', groupTitle: '任务', groupUnit: '完成', completeVerb: '已声明完成', runningVerb: '正在确认完成' },
  background_query: { icon: 'backgroundQuery', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '状态', completeVerb: '已读取后台状态', runningVerb: '正在读取后台状态' },
  background_wait: { icon: 'backgroundWait', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '等待', completeVerb: '后台等待已结束', runningVerb: '正在等待后台任务' },
  background_result: { icon: 'backgroundResult', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '结果', completeVerb: '已读取后台结果', runningVerb: '正在读取后台结果' },
  background_message: { icon: 'backgroundMessage', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '消息', completeVerb: '已发送后台消息', runningVerb: '正在发送后台消息', mutation: true },
  background_cancel: { icon: 'backgroundCancel', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '取消', completeVerb: '已取消后台任务', runningVerb: '正在取消后台任务', mutation: true, errorAccent: true },
  background_join: { icon: 'backgroundJoin', groupKind: 'task', category: '后台任务', groupTitle: '后台任务', groupUnit: '汇合', completeVerb: '已汇合后台任务', runningVerb: '正在汇合后台任务' },
...
export const getToolFamily = (toolName: string): WorkProcessToolFamily => {
  ...
  if (
    ...
    || normalized === 'rdc_context'
    || normalized === 'rdc_probe'
