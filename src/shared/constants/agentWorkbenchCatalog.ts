...
export const AGENT_WORKBENCH_TOOL_CATALOG: AgentWorkbenchToolDeclaration[] = [
  ...
  },
  {
    ...
    label: 'Read Artifact',
    permission: 'readonly',
    inputSchema: { type: 'object', required: ['uri'], properties: { uri: { type: 'string' } } },
    resultSummary: 'Reads a session:// artifact for the owning session.',
    icon: 'file-symlink',
    approvalRequired: false,
  },
  {
  ...
  },
  {
    ...
    permission: 'readonly',
    inputSchema: { type: 'object', properties: {} },
    resultSummary: 'Reads current RDC/RDC runtime context.',
    icon: 'monitor-dot',
    approvalRequired: false,
  },
  {
    ...
    resultSummary: 'Runs a Settings-configured read-only RDC-Tool CLI probe and returns a structured summary.',
    icon: 'radar',
    approvalRequired: false,
  },
  {
...
export const AGENT_WORKBENCH_COMMAND_CATALOG: AgentWorkbenchCommandDeclaration[] = [
  ...
  },
  {
    ...
    relatedTools: ['read_file', 'memory_read', 'rdc_context'],
    permission: 'readonly',
  },
  {
    command: '/memory',
  ...
  },
  {
    ...
    relatedTools: ['task_list', 'task_get', 'rdc_context'],
    permission: 'readonly',
  },
  {
    command: '/model',
