...
- user：`~/.rdc-agent/agents/*.agent.md`
- project：`<project-root>/.rdc-agent/agents/*.agent.md`
...
---
name: Debugger
description: General executable RDC/RDC debugging agent.
