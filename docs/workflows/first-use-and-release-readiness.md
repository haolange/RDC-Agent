...
| RC5-2 验证 | 通过 | 聚焦测试、完整 coverage/type/lint/contracts/gates/build，Browser QA 与原生图标 |
| RC5-3 发布 | 通过 | rc.5 包校验、main/tag/资产 digest、未签名预发布 |
| RC5-4 清理 | 通过 | 自有进程/临时产物清理、证据账本与桌面启动权 |
