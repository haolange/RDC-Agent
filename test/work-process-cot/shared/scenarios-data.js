      ...
      '02': {
        ...
        wp: {
          ...
          sections: [{
            ...
            prose: {
              html: en ? '<p>Checking the configured RDC shell action next…</p>' : '<p>下一步检查已配置的 RDC shell action…</p>',
              streaming: true,
            },
            items: [
              { type: 'tool', tool: { name: 'rdc_context', status: 'running', body: en ? 'Reading session lease…' : '正在读取 session lease…' } },
              { type: 'tool', tool: { name: 'bash', status: 'complete', command: 'echo $RDC_ACTION' } },
        ...
        wp: {
          ...
          sections: [{
            ...
            items: [
              ...
              { type: 'tool', tool: { name: 'rdc_context', body: 'ownerSession=sess_1' } },
