...
5. Run the intervention through the Settings-configured RDC-Tool CLI. Use Replay Benchmark protocol `A-B-A` (or `ABABAB` when the plan requires it). Record metrics and visual before / after / diff.
