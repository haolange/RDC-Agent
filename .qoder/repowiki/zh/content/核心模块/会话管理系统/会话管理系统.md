...
## 更新摘要
**变更内容**
- **RDX到RDC重命名**：将RdxSessionService重命名为RdcSessionService，RdxRuntimeContextRegistry重命名为RdcRuntimeContextRegistry
- **运行时上下文注册表更新**：所有会话相关组件现在使用RDC身份标识
...
**图表来源**
- [RdcSessionService.ts:95-146](file://src/main/sessions/RdcSessionService.ts#L95-L146)
- [RdcSessionService.ts:156-170](file://src/main/sessions/RdcSessionService.ts#L156-L170)
- [RdcSessionService.ts:221-226](file://src/main/sessions/RdcSessionService.ts#L221-L226)
...
- [RdcSessionService.ts:267-288](file://src/main/sessions/RdcSessionService.ts#L267-L288)
...
**章节来源**
- [ExecutionOfferStore.ts:42-81](file://src/main/sessions/ExecutionOfferStore.ts#L42-81)
...
- RdcSessionService 依赖 rdxShellActionService 与 rdxCliInvokerService 执行原生动作，依赖 replayDeviceService 管理回放设备，依赖 settingsService 获取 CLI 配置。
...
- **新增** RdcReplayObservation 依赖 RdxCliInvokerService 执行CLI命令，依赖 ReplayLivePreviewStore 存储实时预览。
...
- [RdcSessionService.ts:1-15](file://src/main/sessions/RdcSessionService.ts#L1-L15)
