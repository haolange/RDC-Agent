...
章节来源
- [ShutdownCoordinator.ts:1-113](file://src/main/lifecycle/ShutdownCoordinator.ts#L1-L113)
- [ProcessSupervisor.ts:1-425](file://src/main/runtime/ProcessSupervisor.ts#L1-L425)
- [ResourceExecutionLifetime.ts:1-21](file://src/main/runtime/ResourceExecutionLifetime.ts#L1-L21)
...
章节来源
- [ShutdownCoordinator.ts:5-113](file://src/main/lifecycle/ShutdownCoordinator.ts#L5-L113)
...
图表来源
- [ShutdownCoordinator.ts:55-109](file://src/main/lifecycle/ShutdownCoordinator.ts#L55-L109)
...
- 阶段定义与顺序
  - 运行态 running → stop_accepting_turns → abort_all → join_producers → terminate_processes → flush_storage → exited
  - 阶段顺序即“依赖倒序”，先停止接受新任务，再中止进行中任务，再等待生产者结束，最后终止进程与刷新存储。
- 超时与强制退出
...
章节来源
- [ShutdownCoordinator.ts:5-113](file://src/main/lifecycle/ShutdownCoordinator.ts#L5-L113)
- [ShutdownCoordinator.test.ts:4-75](file://src/main/lifecycle/ShutdownCoordinator.test.ts#L4-L75)
...
```mermaid
graph LR
SC["ShutdownCoordinator"] --> PS["ProcessSupervisor"]
...
章节来源
- [ShutdownCoordinator.ts:89-109](file://src/main/lifecycle/ShutdownCoordinator.ts#L89-L109)
...
## 结论
本生命周期方案通过三个阶段协同工作，实现了可预测、可控、可观测的应用启停：
