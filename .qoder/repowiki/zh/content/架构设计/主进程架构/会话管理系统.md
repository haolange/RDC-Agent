...
- RdcSessionService 的会话生命周期（创建、切换、销毁）与运行时上下文管理
...
## 架构总览
会话管理由“会话生命周期”和“对话编排”两条主线组成，底层通过 StorageAdapter 进行持久化。IPC 层将 UI 请求路由到 ConversationService，RdcSessionService 在需要时介入捕获与运行时上下文。
...
- 构建环境变量：为子进程注入 RDC_TOOL_CONTEXT_ID、RDC_TOOL_RUNTIME_OWNER、RDC_TOOL_OWNER_LEASE_ID、RDC_TOOL_REPLAY_SESSION_ID、RDC_TOOL_CAPTURE_FILE_ID。
...
章节来源
- [RdcSessionService.ts:69-212](file://src/main/sessions/RdcSessionService.ts#L69-L212)
- [RdcSessionService.ts:214-229](file://src/main/sessions/RdcSessionService.ts#L214-L229)
- [RdcSessionService.ts:231-300](file://src/main/sessions/RdcSessionService.ts#L231-L300)
- [RdcSessionService.ts:301-343](file://src/main/sessions/RdcSessionService.ts#L301-L343)
- [RdcSessionService.ts:345-391](file://src/main/sessions/RdcSessionService.ts#L345-L391)
- [RdcSessionService.ts:457-479](file://src/main/sessions/RdcSessionService.ts#L457-L479)
...
## 依赖关系分析
- RdcSessionService 依赖 rdcShellActionService、replayDeviceService、settingsService、runtimeLogService 等外部服务，并通过 RdcRuntimeContextRegistry 管理会话级租约。
