...
- [en/control.ts](file://src/renderer/i18n/locales/en/control.ts)
- [zh-CN/control.ts](file://src/renderer/i18n/locales/zh-CN/control.ts)
</cite>

## 更新摘要
**变更内容**
- 更新了状态指示器翻译，在英文和中文语言包中添加了 'Failed' 和 'Cancelled' 状态的完整翻译
- 移除了已弃用的 'Subagent' 标签翻译，保持所有支持语言的一致性
- 增强了控制模块的状态显示功能，提供更准确的任务状态反馈
...
- [en/app.ts:1-43](file://src/renderer/i18n/locales/en/app.ts#L1-L43)
- [zh-CN/app.ts:1-43](file://src/renderer/i18n/locales/zh-CN/app.ts#L1-L43)
...
### 状态指示器翻译增强
**更新** 本次更新增强了状态指示器的翻译支持，特别是在控制模块中添加了完整的失败和取消状态翻译。

- 新增状态翻译
  - control.rightRail.artifacts.status.failed: 'Failed' / '失败'
  - control.rightRail.artifacts.preview.yes: 'Failed' / '校验失败'
  - control.replay.cancel: 'Cancel' / '取消'
- 移除废弃翻译
  - 移除了已弃用的 'Subagent' 标签相关翻译
- 一致性保证
  - 确保所有支持语言（英文和中文）的状态翻译保持一致性
  - 增强了任务执行状态的用户反馈体验

章节来源
- [en/control.ts:46-51](file://src/renderer/i18n/locales/en/control.ts#L46-L51)
- [zh-CN/control.ts:46-51](file://src/renderer/i18n/locales/zh-CN/control.ts#L46-L51)
- [en/control.ts:66-67](file://src/renderer/i18n/locales/en/control.ts#L66-L67)
- [zh-CN/control.ts:66-67](file://src/renderer/i18n/locales/zh-CN/control.ts#L66-L67)
- [en/control.ts:215](file://src/renderer/i18n/locales/en/control.ts#L215)
- [zh-CN/control.ts:215](file://src/renderer/i18n/locales/zh-CN/control.ts#L215)
...
## 结论
本项目采用"英文基集 + 语言覆盖"的轻量级 i18n 方案，结合 React Hook 与全局设置 store，实现了简洁可靠的动态语言切换与参数化文案。通过模块化翻译文件与严格的键类型推导，既保证了可维护性，又降低了出错概率。本次更新特别增强了状态指示器的翻译支持，提供了更准确的任务状态反馈。后续可按需引入懒加载与更完善的语言检测，进一步提升用户体验与性能。
...
- 相关文件参考
  ...
  - 状态翻译：[en/control.ts](file://src/renderer/i18n/locales/en/control.ts)、[zh-CN/control.ts](file://src/renderer/i18n/locales/zh-CN/control.ts)。