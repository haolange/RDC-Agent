...
- 钩子事件类型定义：src/shared/types/rdxRuntime.ts
...
- [rdxRuntime.ts:103-131](file://src/shared/types/rdxRuntime.ts#L103-L131)
...
- 外部依赖
  - 共享类型 rdxRuntime.ts 提供 HookEvent、HookDefinition 等契约。
- 潜在循环依赖
  - 当前模块间单向依赖，未见循环导入迹象。
