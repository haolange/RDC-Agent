...
- 调用通道字典 RENDERER_INVOKE_CHANNEL
  - 按领域（shell/conversation/workflow/agent/memory/knowledge/rdxRuntime/command/tools/llm/settings/project/device/session/run/runtime/capture/context/trace）组织
