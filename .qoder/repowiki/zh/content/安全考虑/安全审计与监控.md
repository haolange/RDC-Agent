...
- [rdx-shell-audit.mjs](file://resources/agent-runtime/hooks/rdx-shell-audit.mjs)
...
A --> H["Shell 审计钩子<br/>rdx-shell-audit.mjs"]
...
- [rdx-shell-audit.mjs:1-39](file://resources/agent-runtime/hooks/rdx-shell-audit.mjs#L1-L39)
...
- rdx-shell-audit.mjs 在执行 shell 前进行安全校验
...
### Shell 审计钩子（rdx-shell-audit.mjs）
- 目的
...
- 耦合与内聚
  ...
  - rdx-shell-audit.mjs 作为前置钩子，与执行链路解耦
...
- 常见问题定位
  ...
  - Shell 执行被拒绝：核对 rdx-shell-audit.mjs 的模式匹配规则，调整命令或配置
